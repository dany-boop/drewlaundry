            ...
            <section className='bg-white md:ml-64 min-h-screen'>
                <div className='p-10 rounded-md w-full'>
                    <div className='flex flex-wrap items-center justify-between pb-6'>
                        <div>
                            <h2 className='text-black text-2xl font-semibold'>Daftar Paket Jasa</h2>
                        </div>
                        <div className='flex flex-wrap items-center justify-between lg:mt-0 mt-5'>
                            ...
                            <div className='lg:ml-20 ml-10 space-x-8'>
                                <Link to='/admin/package/add' className='flex items-center justify-center bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded-md text-white font-semibold tracking-wide cursor-pointer'><FaFolderPlus className='mr-2' /> Tambah Paket Jasa</Link>
                            </div>
                        </div>
                    </div>
                    <div>
                                                    ...
                                                    data.map((val, index) => {
                                                        return (
                                                            <tr key={index}>
                                                                ...
                                                                <td className='px-5 py-5 border-b border-gray-200 bg-white text-sm'>
                                                                    <Link to={`/admin/package/edit/${val._id}`} className='flex items-center justify-center bg-yellow-500 hover:bg-yellow-600 px-4 py-2 rounded-md text-white font-semibold tracking-wide cursor-pointer'><FaEdit className='mr-2' /> change</Link>
                                                                </td>
                                                            </tr>
                                                        )
                                                    })
